...
class TaskSettingPipeModel(TaskSettingModel):
    ...
    def camel_to_snake(self, camel_string: str) -> str:
        ...
        return camel_pattern.sub('_', camel_string.replace(' ', '').replace('-', '')).lower()
